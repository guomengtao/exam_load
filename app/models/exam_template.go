...
type ExamTemplate struct {
	...
	CreatedAt *time.Time `gorm:"column:created_at" json:"created_at" validate:"required,max=255"`
	UpdatedAt *time.Time `gorm:"column:updated_at" json:"updated_at" validate:"required,max=255"`
